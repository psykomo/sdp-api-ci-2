...
use App\Modules\Wbp\Models\WbpReleaseModel;
...
class PembebasanWbp
{
    ...
    public function __construct(
        ...
        protected WbpReleaseModel $releases = new WbpReleaseModel(),
        protected WbpFinder $finder = new WbpFinder(),
    ...
    public function execute(int $inmateId, array $command): array
    {
        ...
        return $this->unitOfWork->run(function () use (
            ...
            $this->audit->record('wbp.released', $inmateId, $organizationId, [
