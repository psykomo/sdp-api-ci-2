...
namespace App\Modules\Transfer\Database\Migrations;

use CodeIgniter\Database\Migration;

class CreateInmateTransfersTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
        ...
        $this->forge->addForeignKey('inmate_id', 'inmates', 'id', 'RESTRICT', 'CASCADE');
