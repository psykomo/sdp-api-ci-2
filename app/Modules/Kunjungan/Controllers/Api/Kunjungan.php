...
namespace App\Modules\Kunjungan\Controllers\Api;

use App\Libraries\ApiResponse;
use App\Libraries\MapsApiExceptions;
use App\Modules\Kunjungan\Services\KunjunganService;
 ...
 *
 * @see \App\Modules\Kunjungan\Services\KunjunganService
 */
class Kunjungan extends ResourceController
{
    ...
    public function __construct(
        protected ?KunjunganService $visits = null,
    ) {
        $this->visits ??= Services::kunjunganService();
    }
