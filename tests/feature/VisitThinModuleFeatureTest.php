...
/**
 * Feature coverage for the thin-module reference (Visit).
 *
 * @internal
 */
final class VisitThinModuleFeatureTest extends ApiFeatureTestCase
{
    ...
    public function testListVisitsIsOrgScoped(): void
    {
        ...
        $cipList = $this->asOrgUser($cipinangToken, $cipinangId)->get('api/v1/visits');
