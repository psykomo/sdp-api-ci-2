 ...
 * @internal
 */
final class InmateRegisterFeatureTest extends ApiFeatureTestCase
{
    public function testRegisterInmateBindsActiveOrgAndCreatesAudit(): void
    {
    ...
    public function testListInmatesIsOrgScoped(): void
    {
        ...
        $cipList = $this->asOrgUser($cipinangToken, $cipinangId)->get('api/v1/inmates');
        ...
        $salList = $this->asOrgUser($salembaToken, $salembaId)->get('api/v1/inmates');
